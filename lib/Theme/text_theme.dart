...
class HTexttheme{
  ...
  static TextTheme lightTextTheme=TextTheme(
    // copy with is used to change the properties in exsisting style
    ...
    titleLarge:const TextStyle().copyWith(fontSize: 40.0,fontWeight: FontWeight.w600,color: Colors.black),
...
// customized dark text theme   
  static TextTheme darkTextTheme=TextTheme(
    ...
    titleLarge:const TextStyle().copyWith(fontSize: 40.0,fontWeight: FontWeight.w600,color: Colors.white),
